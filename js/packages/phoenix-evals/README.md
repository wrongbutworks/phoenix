...
This package is built on [AI SDK](https://ai-sdk.dev/) v7, which requires Node.js 22 or newer. Use AI SDK v7-compatible model provider packages (e.g. `@ai-sdk/openai` v4+).
